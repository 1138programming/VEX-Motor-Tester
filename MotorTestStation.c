...
#pragma config(Motor,  port2,           TestMotor,     tmotorVex393_MC29, openLoop, encoderPort, I2C_1)
	...
	while (true)
	{
		...
		switch (lcdState) {
			...
			case 1:
				...
				break;
			case 2:
				displayLCDCenteredString(0, "Encoder:");
				sprintf(offsetStr, "%d", SensorValue[encoder]);
